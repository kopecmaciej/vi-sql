...
-- ============================================================
IF OBJECT_ID('orders.v_order_summary',    'V') IS NOT NULL DROP VIEW [orders].v_order_summary;
IF OBJECT_ID('catalog.v_active_products', 'V') IS NOT NULL DROP VIEW catalog.v_active_products;
IF OBJECT_ID('auth.v_active_users',       'V') IS NOT NULL DROP VIEW auth.v_active_users;
...
CREATE VIEW catalog.v_active_products AS
SELECT
    p.id,
    p.sku,
    p.name,
